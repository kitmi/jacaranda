...
_config.default.addValidatorToMap(OP_MATCH, (left, right, options, context1)=>{
    if (Array.isArray(right)) {
        const errors = [];
        right.every((rule)=>{
...
_config.default.addValidatorToMap(OP_MATCH_ANY, (left, right, options, context1)=>{
    if (!Array.isArray(right)) {
...
_config.default.addValidatorToMap(OP_ALL_MATCH, (left, right, options, context1)=>{
...
_config.default.addValidatorToMap(OP_ANY_ONE_MATCH, (left, right, options, context1)=>{
    if (!Array.isArray(left)) {
...
_config.default.addValidatorToMap(OP_TYPE, (left, right, options, context1)=>{
...
_config.default.addValidatorToMap(OP_START_WITH, (left, right, options, context1)=>{
...
_config.default.addValidatorToMap(OP_END_WITH, (left, right, options, context1)=>{
    if (typeof left !== 'string') {
        return false;
    }
    right = processRightValue(right, context1);
...
_config.default.addValidatorToMap(OP_MATCH_PATTERN, (left, right, options, context1)=>{
    if (typeof left !== 'string') {
        return false;
    }
    right = processRightValue(right, context1);
...
_config.default.addValidatorToMap(OP_CONTAINS, (left, right, options, context1)=>{
    if (typeof left !== 'string') {
        return false;
    }
    right = processRightValue(right, context1);
...
_config.default.addValidatorToMap(OP_SAME_AS, (left, right, options, context1)=>{
    if (typeof left === 'object') {
