...
const UNSUPPORTED_DEFAULT_VALUE = new Set([
    "BLOB",
    "TEXT",
    "JSON",
    "GEOMETRY"
        ...
        switch(assoc.type){
            ...
            case "hasMany":
                ...
                if (backRef) {
                    ...
                    // semi association
                    let connectedByParts = assoc.by ? assoc.by.split(".") : [
            ...
            case "belongsTo":
                ...
                if (assoc.with) {
                    Object.assign(joinOn, this._oolConditionToQueryCondition({
                        ...assocNames,
