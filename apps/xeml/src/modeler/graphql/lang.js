const { _, pascalCase } = require('@kitmi/utils');
...
function toGraphQLType(fieldMeta) {
    ...
    switch (fieldMeta.type) {
        ...
        case 'enum':
            result.newType = pascalCase(
                fieldMeta.subClass && fieldMeta.subClass.length > 0 ? _.last(fieldMeta.subClass) : fieldMeta.name
            );
